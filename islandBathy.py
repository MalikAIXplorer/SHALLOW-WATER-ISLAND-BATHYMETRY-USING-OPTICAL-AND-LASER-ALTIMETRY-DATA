...
def main(csvs,rasterFile):
    ...
    df.to_csv("C:/Users/MALIK JUNAID/OneDrive/Desktop/ISRO/Islands/Bitra/Bitra_new.csv")
    ...
    out_ds = driver.Create(r"C:\Users\MALIK JUNAID\OneDrive\Desktop\ISRO\Islands\Bitra\test.tif", predictions.shape[1], predictions.shape[0], 1, gdal.GDT_Float32)
...
if __name__=="__main__":
    ...
    inputCSVs = glob.glob(r"C:\Users\MALIK JUNAID\OneDrive\Desktop\ISRO\Islands\Bitra\20*.csv")
    # inputCSVs=["/media/bharath/DATA/TDP/TDP-SurfaceWaterTrends/data/islands/kadamat/validPoints.csv"]
    #S2RasterFile
    inputRaster=r"C:\Users\MALIK JUNAID\OneDrive\Desktop\ISRO\Islands\Bitra\Bitra.tif"
