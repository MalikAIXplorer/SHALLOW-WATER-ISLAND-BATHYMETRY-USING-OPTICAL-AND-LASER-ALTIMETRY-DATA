...
def dbscanforseafloor(df):
    ...
    plt.show()
def main():
    df = pd.read_csv(r'C:\Users\MALIK JUNAID\OneDrive\Desktop\ISRO\Islands\Bitra\data.csv')
    ...
    boundsToGetPasses = "72.130081,11.494966,72.192133,11.609366"
    ...
    for i in range(len(dts)):
        ...
        eachDt = dts.iloc[[i]]
        csvName = r"C:\Users\MALIK JUNAID\OneDrive\Desktop\ISRO\Islands\Bitra\{}_{}.csv".format(np.array(eachDt)[0][0], np.array(eachDt)[0][1])
